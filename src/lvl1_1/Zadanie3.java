...
Поцелуй мой блестящий металлический корпус!

Требования:
1. Программа должна выводить текст.
2. Текст должен начинаться с «Меня зовут Амиго».
3. Текст должен заканчиваться на «металлический корпус!».
...
public class Zadanie3 {
     public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Поцелуй мой блестящий металлический корпус!");               
    }
}
